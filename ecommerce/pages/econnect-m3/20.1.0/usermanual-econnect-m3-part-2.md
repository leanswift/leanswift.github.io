...
Please refer to **[Part I](https://github.com/leanswift/leanswift.github.io/blob/master/ecommerce/pages/econnect-m3/20.1.0/usermanual-econnect-m3-part-1.md)** of the User Manual for the required configuration behind each of the transactions.
