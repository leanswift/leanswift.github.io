...
- [Version 21.1.0 - User Manual - Admin User](#version-2010---user-manual---admin-user)
...
With 21.1.0, there is a major technical architectural change in the solution. BODs from ION are now configured to be sent to a REST API in Magento, which in turn sends them to RabbitMQ for storage and processing by eConnect. In the previous versions, ION sends BODs to RabbitMQ directly.
- LeanSwift AMQP Connection
    - Separate AMQP connection to handle the eConnect related BODs in RabbitMQ.
    - Provided the  RabbitMQ section  in the Magento admin to configure the credentials

<kbd>
<kbd><img alt="Registration Page with econnect" src="../../images/usermanual/architecture_21.1.0.png"></kbd>
</kbd>
