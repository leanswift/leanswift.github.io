...
Provide an option to select request approver.
    ...
    - Generic Admin Group: When this option is selected it will enable another option Admin Group Name in this will be giving the group name which in created in Infor M3. To view the groups, click on Profile icon->User Management->Users->Manage->Groups.
