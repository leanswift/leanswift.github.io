...
To view the user manual for Portal Users, click [here](https://leanswift.github.io/master/supplierportal/src/pages/23.4.0_PWA/usermanual-supplierportal-user.md).
